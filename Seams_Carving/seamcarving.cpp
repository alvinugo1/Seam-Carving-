...
int main() {
  ...
  //if (targetWidth == width){
	  //cout << "Error: target width must be less than width, " << targetWidth << " is equal to " << width << endl;
	  //return 1;
  //}
  ...
  //if (targetHeight == height){
	  //cout << "Error: target height must be less than height, " << targetHeight << " is equal to " << height << endl;
	  //return 1;
  //}
